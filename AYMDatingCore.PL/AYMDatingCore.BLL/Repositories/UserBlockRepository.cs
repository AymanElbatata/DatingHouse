...
{
    public class UserBlockRepository : GenericRepository<UserBlockTBL>, IUserBlockRepository
    {
        private readonly AymanDatingCoreDbContext _context;

        public UserBlockRepository(AymanDatingCoreDbContext context) : base(context)
        {
            _context = context;
        }
    }
