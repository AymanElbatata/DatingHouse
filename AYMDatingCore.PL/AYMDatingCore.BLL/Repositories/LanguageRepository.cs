...
{
    public class LanguageRepository : GenericRepository<LanguageTBL> , ILanguageRepository
    {
        private readonly AymanDatingCoreDbContext _context;

        public LanguageRepository(AymanDatingCoreDbContext context) : base(context)
        {
            _context = context;
        }
