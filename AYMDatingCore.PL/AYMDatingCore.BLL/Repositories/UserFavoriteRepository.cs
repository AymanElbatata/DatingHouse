...
{
    public class UserFavoriteRepository : GenericRepository<UserFavoriteTBL>, IUserFavoriteRepository
    {
        private readonly AymanDatingCoreDbContext _context;

        public UserFavoriteRepository(AymanDatingCoreDbContext context) : base(context)
        {
            _context = context;
        }
    }
