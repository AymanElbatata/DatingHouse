...
{
    public class UserImageRepository : GenericRepository<UserImageTBL>, IUserImageRepository
    {
        private readonly AymanDatingCoreDbContext _context;

        public UserImageRepository(AymanDatingCoreDbContext context) : base(context)
        {
            _context = context;
        }
    }
